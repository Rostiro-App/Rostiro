  ...
  return (
    <section className="px-4 md:px-6 py-16 md:py-24" style={{ backgroundColor: 'var(--glass-solid)' }}>
      <div className="max-w-5xl mx-auto">
        ...
        {/* Founder B-roll clip: connect a second and third league (Sleeper →
            Yahoo → ESPN) back to back, then land on Pulse showing one
        ...
        <div className="mt-14 max-w-2xl mx-auto">
          <ProductVideoDemo
            ...
            recordingNote="Founder B-roll clip: connect a second and third league (Sleeper → Yahoo → ESPN) back to back, then land on Pulse showing one unified list that names all three leagues in the same card."
          />
        </div>
      </div>
    </section>
